...
def main(_model='vgg16', _tiles=24, _tiles_buildin=24, _noc_bw=20, _DSE_indicator=0, _dataflow='kcp_ws', _skip_simu=False):
    ...
    if not (args.disable_hardware_modeling) and not (skip_simu):
